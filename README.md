...
<details><summary><b><a href="https://mujoco.org/">mujoco</a></b> (🥇8 · 📉) -  <code>Unlicensed</code></summary>
...
- [GitHub]() (👨‍💻 15 · 📦 16):
	...
	```
- [PyPi](https://pypi.org/project/ir-sim) (📥 1.4K / month):
	```
	pip install ir-sim
	```
</details>
...
- [GitHub]() (👨‍💻 20 · 📦 9):
	...
	```
- [PyPi](https://pypi.org/project/pyrobosim) (📥 770 / month):
	```
...
- [GitLab](https://gitlab.com/flightgear/flightgear) (🔀 86 · 📋 640 - 36% open · ⏱️ 04.03.2015):
...
- [GitHub]() (👨‍💻 610 · 📦 24K):
	...
	```
- [PyPi](https://pypi.org/project/gymnasium) (📥 4.3M / month):
	```
...
- [GitHub]() (👨‍💻 57):
	...
	```
- [PyPi](https://pypi.org/project/mjlab) (📥 69K / month):
	```
	pip install mjlab
	```
</details>
...
- [GitHub]() (👨‍💻 48 · 📦 120):
	...
	```
- [PyPi](https://pypi.org/project/metaworld) (📥 30K / month):
	```
...
- [GitHub]() (👨‍💻 16 · 📦 4):
	...
	```
- [PyPi](https://pypi.org/project/jaxsim) (📥 3.9K / month):
	```
	pip install jaxsim
	```
...
- [GitHub]() (👨‍💻 9):
	...
	```
- [PyPi](https://pypi.org/project/ksim) (📥 120 / month):
	```
	pip install ksim
	```
</details>
...
- <b><a href="https://www.gymlibrary.dev/">Gym</a></b> (🥉2) -  <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub]() (👨‍💻 23 · 📦 3.2K):
	...
	```
- [PyPi](https://pypi.org/project/pyrender) (📥 1.1M / month):
	```
